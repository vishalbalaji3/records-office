...
appendedFiles <- c(filesAppended_SSN, filesAppended_SID, filesAppended_name, filesAppended_nofn, filesAppended_n0fn)
...
list.save(appendedFiles, paste("appendedFiles",format(Sys.time(), "%Y-%m-%d_%H%M"), ".yaml", sep = ""))
